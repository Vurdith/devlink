      ...
      <div className="relative w-full max-w-md animate-fade-in">
        ...
        <div className="bg-[#0d0d12] rounded-2xl p-8 border border-white/10 animate-slide-up" style={{ animationDelay: '0.1s' }}>
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            {/* Error message */}
            {error && (
              <div id="login-error" role="alert" className="p-3 rounded-xl bg-[var(--color-accent)]/10 border border-[var(--color-accent)]/20 text-[var(--color-accent)] text-sm flex items-center gap-2 animate-fade-in">
