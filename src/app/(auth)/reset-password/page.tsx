...
function ResetPasswordContent() {
  ...
  return (
    <main className="mx-auto max-w-md px-4 py-16">
      ...
      <form onSubmit={handleSubmit} className={surface("panel", "noise-overlay relative overflow-hidden p-6 space-y-4")}>
        <div>
          <label className="block text-sm mb-1">New Password</label>
          <input
            type="password"
            className="w-full h-10 px-3 rounded-lg bg-white/[0.04] border border-white/[0.1] outline-none focus:border-[rgba(var(--color-accent-2-rgb),0.55)] focus:bg-white/[0.07]"
