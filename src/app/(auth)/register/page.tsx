...
export default function RegisterPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await signIn("credentials", { email, password, redirect: true, callbackUrl: "/me" });
    } catch (err: any) {
    ...
    <main className="mx-auto max-w-md px-4 py-16">
      <div className="relative overflow-hidden rounded-[var(--radius)] mb-6">
        ...
        <div className="glass p-6">
          ...
          <p className="text-sm text-[var(--muted-foreground)]">Join DevLink to showcase your portfolio and get hired.</p>
        </div>
      </div>
