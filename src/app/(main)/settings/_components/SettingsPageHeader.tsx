...
export function SettingsPageHeader({
  ...
  return (
    <div className={surface("panel", cn("noise-overlay relative overflow-hidden p-5 animate-fade-in", className))}>
      ...
      <div className="relative flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <h1 className="font-[var(--font-space-grotesk)] text-2xl font-bold text-white">{title}</h1>
