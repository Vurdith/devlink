  ...
  return (
    <main className="mx-auto max-w-5xl px-2 sm:px-4 py-4 sm:py-10">
      <section className="relative overflow-hidden rounded-xl sm:rounded-2xl animate-pulse">
        {/* Banner skeleton */}
        <div className="h-36 sm:h-64 w-full bg-gradient-to-br from-purple-900/30 via-purple-800/20 to-indigo-900/30" />
      ...
      <div className="mt-4 sm:mt-8">
        <div className="flex gap-2 mb-6 bg-black/40 rounded-2xl p-3 border border-purple-500/20">
          {[1, 2, 3, 4, 5].map((i) => (
