        ...
        {followers.map((f) => (
          <div key={f.id} className="group relative glass rounded-[var(--radius)] p-3 flex items-center gap-3">
            ...
            <div className="relative z-10 pointer-events-none min-w-0">
              <div className="text-sm flex items-center gap-2">@{f.follower.username} {currentUserId === f.follower.id && (<span className="text-[10px] px-1.5 py-0.5 rounded bg-white/10 border border-white/10">You</span>)}</div>
