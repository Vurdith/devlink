            ...
            >
              ...
              {isOwnPost && isOriginalPost && onPinToggle && (
                ...
                >
                  ...
                  <span className="font-medium">{post.isPinned ? "Unpin" : "Pin"}</span>
                </button>
              )}
              ...
              {!isOwnPost && (
                <button
                  ...
                  className={menuItem("w-full text-left text-sm text-[var(--color-accent-2)] hover:bg-[rgba(var(--color-accent-2-rgb),0.10)]")}
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
