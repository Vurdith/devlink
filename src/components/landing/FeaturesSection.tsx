...
const features = [
  {
    ...
    description: "Pin builds, scripts, art, and case studies where studios can judge the work without chasing links.",
  ...
  },
  {
    ...
    title: "Find the right maker",
    description: "Search developers, artists, scripters, and builders by the signals that matter for the project in front of you.",
  ...
  },
  {
    ...
    description: "Browse jobs, commissions, and collaboration requests from teams looking for Roblox talent.",
  ...
  },
  {
    ...
    title: "Trust signals",
    description: "Use verification, portfolio proof, and reviews to show clients what they can rely on.",
  ...
  },
  {
    ...
    description: "Collect reviews after real work so your next collaborator can see how you communicate and deliver.",
  ...
  },
  {
    ...
    description: "Post updates, ask for feedback, and keep your network aware of what you are building now.",
        ...
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-start">
          ...
          <div className="animate-fade-in lg:sticky lg:top-32">
            <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl font-bold font-[var(--font-space-grotesk)] tracking-tight">
              ...
              <span className="gradient-text">with receipts</span>
            </h2>
            <p className="mt-4 text-base sm:text-lg text-white/70 leading-relaxed max-w-xl">
              DevLink puts proof, reputation, and contact paths in one place, so teams can decide faster.
            </p>
