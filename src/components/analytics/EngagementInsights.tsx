  ...
  return (
    <AnalyticsCard delay={0.15}>
      ...
      <div className="space-y-3">
        ...
        <div className="p-4 rounded-xl bg-gradient-to-r from-[var(--color-accent)]/10 to-[var(--color-accent)]/10 border border-[var(--color-accent)]/20">
          <div className="flex items-center justify-between">
            <div>
            ...
            <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-accent)]">
