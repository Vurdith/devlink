  ...
  return (
    <AnalyticsCard className="!p-6 space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <button
          type="button"
          className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-semibold text-[var(--color-accent)] transition hover:border-[var(--color-accent)]/40 hover:bg-[var(--color-accent)]/10"
