  ...
  return (
    <button 
      ...
      className={cn(
        ...
        following 
          ? "bg-purple-500/10 text-purple-300 border border-purple-500/30 hover:bg-red-500/15 hover:border-red-500/40 hover:text-red-400"
          : "bg-gradient-to-r from-purple-500 to-purple-600 text-white border border-purple-400/30 shadow-lg shadow-purple-500/30 hover:from-purple-600 hover:to-purple-700"
      )}
    >
