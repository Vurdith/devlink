...
CREATE TABLE "PostRepost" (
    ...
    CONSTRAINT "PostRepost_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO "new_Post" ("content", "createdAt", "id", "mediaUrl", "userId") SELECT "content", "createdAt", "id", "mediaUrl", "userId" FROM "Post";
DROP TABLE "Post";
